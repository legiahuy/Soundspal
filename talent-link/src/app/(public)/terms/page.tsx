...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: `${t('title')} - Soundspal`, url: `${APP_URL}/terms` },
  }
}
...
export default async function TermsPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <p>
          Soundspal is an online platform that facilitates connections between music artists, producers, singers, venues, and event organizers.
          We provide tools to create profiles, post and discover job opportunities, and communicate within the music industry.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          ...
          of your account credentials and for all activities that occur under your account. You agree to provide accurate, current,
    ...
    },
    {
      ...
      content: (
        <p>
          You retain ownership of content you post on the Platform. By posting content, you grant Soundspal a non-exclusive,
          royalty-free license to use, display, and distribute your content in connection with operating the Platform.
    ...
    },
    {
      ...
      content: (
        <p>
          The Platform is provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind. We do not guarantee the accuracy,
          completeness, or usefulness of any content on the Platform. We are not responsible for any agreements, transactions,
    ...
    },
    {
      ...
      content: (
        <p>
          To the maximum extent permitted by law, Soundspal shall not be liable for any indirect, incidental, special, consequential,
          or punitive damages arising from your use of the Platform or any content therein.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <p>
          We may update these Terms of Service from time to time. We will notify users of significant changes by posting a notice
          on the Platform. Your continued use of the Platform after changes constitutes acceptance of the new terms.
        </p>
      ),
    },
    {
